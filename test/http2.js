...
function writeRequest (socketOrSession, chunked) {
  ...
  socketOrSession.write('GET / HTTP/1.1\r\n')
  socketOrSession.write('Host: localhost\r\n')
  socketOrSession.write('Connection: keep-alive\r\n')

  if (chunked) {
    socketOrSession.write('Transfer-Encoding: chunked\r\n')
  }

  socketOrSession.write('\r\n')
}
